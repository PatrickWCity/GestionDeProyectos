...
namespace Gestion_de_Proyectos.Vista
{
    public partial class FormLocalidad : Form
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        tb_Comuna.Visible = false;
                        tb_Providencia.Visible = false;
        ...
        private void b_Restablecer_Click(object sender, EventArgs e)
        {
            ...
            comboBox3.Visible = true;
            comboBox2.Visible = true;
            comboBox1.Text= "Selecionar Region";
            comboBox2.Text = "Selecionar Providencia";
            comboBox3.Text = "Selecionar Comuna";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                comboBox1.Text = dataGridView1.Rows[e.RowIndex].Cells["region"].Value.ToString();
                comboBox2.Text = dataGridView1.Rows[e.RowIndex].Cells["providencia"].Value.ToString();
                comboBox3.Text = dataGridView1.Rows[e.RowIndex].Cells["comuna"].Value.ToString();
                b_Guardar.Enabled = false;
                b_Eliminar.Enabled = true;
                b_Actualizar.Enabled = true;
                tb_Comuna.Visible = false;
        ...
        {
            tb_Comuna.Visible = true;
            tb_Providencia.Visible = true;
            tb_Region.Visible = true;
